...
int main(int argc, char* argv[]) {
	...
	// 	string numplayersdraft;
	// 	cout << "\nHow many players would you like to be on each team?\n";
	// 	cin >> numplayersdraft;

	// 	while ((!cin) || (numplayersdraft < 2) || (numplayersdraft > 12)) {
	// 		cout << "Invalid number of players enetered. Please enter a number of players that is at least 2 and no more than 12.\n";
	// 		cin >> numplayersdraft;
	// 	}
	// }
